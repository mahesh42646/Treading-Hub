        ...
        <div className="row justify-content-center">
          <div className="col-lg-8">
            <div className="text-center mb-5 pt-lg-4">
              <h1 className="display-4  display-md-3 display-sm-5 fw-bold text-primary mb-3">Refund Policy</h1>
            ...
            <div className="card shadow-sm">
              <div className="card-body p-5">
                ...
                <h2 className="h4 mb-4">Monthly Subscription Refunds</h2>
                <ul className="mb-4">
                  <li>Pro-rated refunds available for unused portions of monthly subscriptions</li>
                  <li>Refund requests must be submitted before the next billing cycle</li>
                  <li>Processing fees may apply to subscription refunds</li>
                </ul>
