...
export default function TermsOfUse() {
  return (
    <div className="page-content" style={{
          ...
          <div className="row">
            <div className="col-lg-8 mx-auto text-center pt-lg-5">
              <h1 className="display-5 display-md-3 display-sm-5 fw-bold mb-4 text-white">
                Terms of <span className="text-info">Use</span>
              </h1>
      ...
      {/* Content Section - Dark Glossy Theme */}
      <section className="py-5" style={{
        background: 'linear-gradient(135deg, #110A28 0%, #110A28 100%)',
        color: 'white'
      }}>
            ...
            <div className="col-lg-8 mx-auto">
              <div className="card border-0 rounded-4" style={{
                ...
                <div className="card-body p-5">
                  <p className="text-white-50 mb-4">Last updated: January 15, 2024</p>

                  <h4 className="mb-3 text-white">1. Agreement to Terms</h4>
                  ...
                  <h4 className="mb-3 text-white">2. Description of Service</h4>
                  <p className="mb-4 text-white-50">
                  ...
                  <ul className="mb-4 text-white-50">
                  ...
                  <h4 className="mb-3 text-white">3. Eligibility Requirements</h4>
                  <p className="mb-4 text-white-50">
                  ...
                  <h4 className="mb-3 text-white">4. Account Registration and Security</h4>
                  <p className="mb-4 text-white-50">
                  ...
                  <h4 className="mb-3 text-white">5. Trading Rules and Risk Disclosure</h4>
                  <p className="mb-4 text-white-50">
                    <strong className="text-white">Important Risk Warning:</strong> Trading financial instruments involves substantial risk 
                  ...
                  <h4 className="mb-3 text-white">6. Evaluation Program Terms</h4>
                  <p className="mb-4 text-white-50">
                  ...
                  <h4 className="mb-3 text-white">7. Funded Account Terms</h4>
                  <p className="mb-4 text-white-50">
                  ...
                  <h4 className="mb-3 text-white">8. Payment Terms and Fees</h4>
                  <p className="mb-4 text-white-50">
                  ...
                  <h4 className="mb-3 text-white">9. Prohibited Activities</h4>
                  <p className="mb-4 text-white-50">
                  ...
                  <h4 className="mb-3 text-white">10. Intellectual Property Rights</h4>
                  <p className="mb-4 text-white-50">
                  ...
                  <h4 className="mb-3 text-white">11. Privacy and Data Protection</h4>
                  <p className="mb-4 text-white-50">
                  ...
                  <h4 className="mb-3 text-white">12. Disclaimers and Limitations of Liability</h4>
                  <p className="mb-4 text-white-50">
                  ...
                  <h4 className="mb-3 text-white">13. Indemnification</h4>
                  <p className="mb-4 text-white-50">
                  ...
                  <h4 className="mb-3 text-white">14. Termination</h4>
                  <p className="mb-4 text-white-50">
                  ...
                  <h4 className="mb-3 text-white">15. Governing Law and Dispute Resolution</h4>
                  <p className="mb-4 text-white-50">
                  ...
                  <h4 className="mb-3 text-white">16. Changes to Terms</h4>
                  <p className="mb-4 text-white-50">
                  ...
                  <h4 className="mb-3 text-white">17. Severability</h4>
                  <p className="mb-4 text-white-50">
                  ...
                  <h4 className="mb-3 text-white">18. Contact Information</h4>
                  <p className="mb-4 text-white-50">
                  ...
                  <div className="rounded-4 p-3" style={{
                    ...
                    <p className="mb-1 text-white-50"><strong className="text-white">Email:</strong> legal@xfundingflow.com</p>
                    <p className="mb-1 text-white-50"><strong className="text-white">Phone:</strong> +1 (555) 123-4567</p>
                    <p className="mb-1 text-white-50"><strong className="text-white">Address:</strong> 123 Trading Street, Financial District, New York, NY 10001</p>
                    <p className="mb-0 text-white-50"><strong className="text-white">Support Hours:</strong> Monday - Friday, 9:00 AM - 6:00 PM EST</p>
                  </div>
                  ...
                  <div className="mt-4 p-3 rounded-4" style={{
                    ...
                    <h6 className="text-info fw-bold">Important Notice</h6>
